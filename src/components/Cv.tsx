...
export function Cv() {
    ...
    return (
        <div id="cv" className='flex flex-col gap-4 w-full mb-10'>
            <h2 className='text-white/50 text-2xl font-light'>Curriculum Vitae</h2>

            <div className='flex gap-2 w-full justify-between'>
                <p className='text-white/60 text-lg font-light'>Want to know more about my background and experience?</p>

                <Button
                    asChild
                    className="bg-white/80 text-black hover:bg-gray-700 w-fit"
